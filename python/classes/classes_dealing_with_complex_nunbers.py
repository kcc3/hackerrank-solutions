"""Hackerrank Problem: https://www.hackerrank.com/challenges/class-1-dealing-with-complex-numbers/problem
...
class Complex(object):
    ...
    def __add__(self, no):
        return '{0:.2f}{1:+.2f}i'.format(self.real + no.real, self.imaginary + no.imaginary)
    ...
    def mod(self):
        return '{0:.2f}{1:+.2f}i'.format(math.sqrt(self.real ** 2 + self.imaginary ** 2), 0)
